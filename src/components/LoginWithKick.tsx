...
import { useSwitchStore } from '../assets/features/chat/switchStore';
...
const LoginWithKick: React.FC = () => {
  ...
  return (
    <>
      ...
      <button onClick={toggleState}>{isLoading ? 'Loading...' : isActive ? 'Pornire abonare' : 'Opreste abonarea'}</button>
    </>
